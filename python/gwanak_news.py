...
# 관악지역 뉴스 목록을 가져오는 라우트
api = 'http://openapi.seoul.go.kr:8088/{key}/xml/GwanakNewsList/1/5/'
...
app = Blueprint('gw5', __name__, url_prefix='/gw5')

@app.route('/gwanakNewsList', methods=['GET'])
def gwanakNewsList():
    return result_json